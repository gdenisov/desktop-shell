---
name: welcome
description: "Greet the user when a new project starts. This mind was created from the Desktop Shell template, so the welcome introduces that template and immediately starts the adaptation conversation."
---

# Welcome the user (template: Desktop Shell)
...
1. Open with a short CUSTOM welcome that names **Desktop Shell** and gives the
